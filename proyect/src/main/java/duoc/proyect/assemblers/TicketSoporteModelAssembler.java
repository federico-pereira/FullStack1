...
@Component
public class TicketSoporteModelAssembler implements
        RepresentationModelAssembler<TicketSoporte, EntityModel<TicketSoporte>> {
    ...
    public EntityModel<TicketSoporte> toModel(TicketSoporte ticket) {
        return EntityModel.of(ticket,
                ...
                linkTo(methodOn(TicketSoporteControllerV2.class).getAllTickets()).withRel("tickets")
        );
    }
}